...
///
/// Payload is opaque bytes at the contract level. The wire protocol in
/// SDK pass 3 defines transport-level framing; the shelf shape defines
/// the on-the-wire content. Plugins deserialise per the shelf's schema.
#[derive(Debug, Clone)]
pub struct Request {
