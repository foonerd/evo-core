...
//! plugin SDK's [`evo_plugin_sdk::host::run_oop`] helper, and exits
//! when the steward disconnects.
//!
//! This is the minimal binary shape of an out-of-process plugin.
//! Third-party plugin authors copy this skeleton and substitute their
//! own `Plugin + Respondent` implementation.
//!
//! ## Usage
//!
//! ```text
